 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/zip zip} to zip iterables.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/async/chain chain} to chain iterables asynchronously.
 *
