 ...
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/last last} to get the last element.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/filter filter} to filter elements.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/async/find find} to find elements asynchronously.
 *
