 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/every every} to check if every
 * element satisfies the provided function.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/async/some some} to check asynchronously.
 *
