 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/map/~/map map} to map values to iterables.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/filter/~/filter filter} to filter values.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/flatten/~/flatten flatten} to flatten an iterable of iterables.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/flat-map/~/flatMap flatMap} to flat map an iterable asynchronously.
 *
