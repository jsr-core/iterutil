 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/take/~/take take} to limit the number of items of the cycled iterable.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/cycle/~/cycle cycle} to cycle the iterable asynchronously.
 *
