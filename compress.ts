 ...
 * Use {@linkcode https://jsr.io/@core/iterutil/filter filter} to remove values based on a function.
 * Use {@linkcode https://jsr.io/@core/iterutil/async/compress compress} to compress iterables asynchronously.
 *
