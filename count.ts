 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/take take} to limit the number of items.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/range range} to generate a sequence of numbers within a range.
 *
