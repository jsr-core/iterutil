 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/some some} to check if any element satisfies the function.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/~/async/every every} to check asynchronously.
 *
