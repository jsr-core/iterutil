 ...
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/for-each/~/forEach forEach} to call a function for each value.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/flat-map/~/flatMap flatMap} to flat map an iterable.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/flatten/~/flatten flatten} to flatten an iterable.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/map/~/map map} to map synchronously.
 *
