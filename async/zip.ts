 ...
 *
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/chain/~/chain chain} to chain iterables.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/async/enumerate/~/enumerate enumerate} to zip with indices.
 * Use {@linkcode https://jsr.io/@core/iterutil/doc/zip/~/zip zip} to zip iterables synchronously.
 *
